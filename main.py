...
def main():
    ...
    # t.gen_text("Copyright (C) 2023, \x1b[31mAr Softwares Inc.\x1b[0m", 2)
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text("ariusxi", 3, contin=True)
    ...
    git_user_details = gifos.utils.fetch_github_stats("ariusxi", ignore_repos)
    user_age = gifos.utils.calc_age(26, 7, 2002)
    t.clear_frame()
    top_languages = [lang[0] for lang in git_user_details.languages_sorted]
    user_details_lines = f"""
    \x1b[30;101mariusxi@GitHub\x1b[0m
    --------------
    ...
    --------------
    \x1b[96mEmail:      \x1b[93malef.developerweb@gmail.com\x1b[0m
    \x1b[96mLinkedIn:   \x1b[93malef-felix\x1b[0m
    ...
    t.gen_typing_text(" -u ariusxi", 1, contin=True)
    ...
    t.toggle_show_cursor(True)
    # t.pasteImage("./temp/ariusxi.jpg", 3, 5, sizeMulti=0.5)
    t.gen_text(user_details_lines, 2, 35, count=5, contin=True)
    t.gen_prompt(t.curr_row)
    t.gen_typing_text(
        "\x1b[92m# Lets make the world better with technology!",
        t.curr_row,
        contin=True,
    )
